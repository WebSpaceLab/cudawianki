...
<template>
    <div
        id="AuthOverlay"
        class="fixed flex items-center justify-center z-50 top-0 left-0 w-full h-full bg-black/20 bg-opacity"
    >
        <div class="relative bg-background-light dark:bg-background-dark w-full max-w-[470px] h-[70%] p-4 rounded-lg shadow-xl shadow-black">
            ...
            <div class="mt-20">
                <FormLogin v-if="isRegister" />

                <FormRegister v-else />
            </div>

            <div class="absolute flex items-center justify-center py-5 left-0 bottom-0 border-t-solid w-full">
