...
<template>
    ...
    >
        ...
        <div class="w-full h-full absolute top-0 left-0 z-1 bg-black/60 flex justify-center items-center rounded-lg" >
            <p class="sm:text-xs text-center text-white md:text-sm lg:text-lg" :class="classTextColor(item.color)">
                {{ item.title }}
            </p>
        </div>
    </x-link>
