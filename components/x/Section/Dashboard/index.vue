...
<template>
    <section
        class="relative w-full  mx-auto px-6"
        :class="[
            container ? 'container' : ''
        ]"
    >
        <x-section-dashboard-header :title="title">
            <template #panel>
        ...
        >
            <div v-if="isShowSettingsSidebar"  class="fixed top-0 right-0 w-96 h-screen shadow-lg shadow-black bg-gradient-to-r from-prime-light/80 to-second-light/80 dark:from-prime-dark/80 dark:to-second-dark/80 backdrop-blur z-50 border-solid border-green-500">
                <slot name="sidebar" />
            </div>
        </transition>
    </section>
